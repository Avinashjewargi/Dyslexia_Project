// frontend/phonology/PhonologyHub.jsx
  ...
  const activities = [
    {
      ...
      description: 'Practice spelling words from easy to challenging',
      color: 'primary',
      levels: 3,
    ...
    },
    {
      ...
      description: 'Replace letters to make new words',
      color: 'success',
      levels: 1,
    ...
    <Container fluid className="py-4">
      <div className="text-center mb-4">
        <h1 className="text-primary mb-2">
          ...
          Phonological Awareness Center
        </h1>
        <p className="text-muted">
          Practice your reading skills with fun activities!
        </p>
      </div>
              ...
              <Card.Body className="text-center">
                ...
                {activity.levels > 1 && (
                  <Badge bg="info" className="mb-2">
                    Level {userProgress[activity.id]?.level || 1} / {activity.levels}
                  </Badge>
                )}
                
                <div className="mt-3">
                  <small className="text-muted">
                    Progress: {userProgress[activity.id]?.completed || 0} / {userProgress[activity.id]?.total || 0}
                  </small>
      ...
      <Card className="mt-4 bg-light">
        <Card.Body>
          <h5 className="text-info">💡 Tips for Parents & Teachers</h5>
          <ul className="mb-0">
            <li>Start with easier activities and gradually increase difficulty</li>
            <li>Celebrate small victories to build confidence</li>
            <li>Practice for 10-15 minutes daily for best results</li>
            <li>Use the color coding feature alongside these activities</li>
          </ul>
        </Card.Body>
      </Card>
    </Container>
