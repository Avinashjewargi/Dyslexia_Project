...
function BirdsWorld() {
  ...
  const waterBirds = [
    ...
    { word: 'seagull', emoji: '🕊️', audioText: 'Seagull - Beach bird', description: 'Near ocean' },
  ...
  const birdsOfPrey = [
    ...
    { word: 'vulture', emoji: '🦅', audioText: 'Vulture - Scavenger bird', description: 'Cleans environment' },
  ];
  ...
  const farmBirds = [
    ...
    { word: 'rooster', emoji: '🐓', audioText: 'Rooster - Male chicken', description: 'Crows in morning' },
  ...
  // 🌿 Other / Special Birds
  const otherBirds = [
    { word: 'woodpecker', emoji: '🦜', audioText: 'Woodpecker - Pecks trees', description: 'Makes tapping sound' },
    { word: 'stork', emoji: '🦤', audioText: 'Stork - Long legs bird', description: 'Wading bird' },
    { word: 'crane', emoji: '🦤', audioText: 'Crane - Tall elegant bird', description: 'Long neck' },
    { word: 'magpie', emoji: '🐦‍⬛', audioText: 'Magpie - Black and white bird', description: 'Likes shiny things' },
  ...
  return (
    <>
      ...
      <LearningCard title="Birds of Prey" subtitle="Strong hunting birds" category="🐦 Birds" categoryColor="#2ECC71" items={birdsOfPrey} />
      ...
      <LearningCard title="Flightless Birds" subtitle="Cannot fly" category="🐦 Birds" categoryColor="#95A5A6" items={flightlessBirds} />
      <LearningCard title="Special Birds" subtitle="Unique birds" category="🐦 Birds" categoryColor="#9B59B6" items={otherBirds} />
    </>
  );
}
